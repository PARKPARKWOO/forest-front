          ...
          content: (
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-xl border-l-4 border-green-500">
                <h2 className="text-2xl font-bold text-green-800 mb-6 text-center">환영합니다</h2>
              ...
              <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-400">
                <h3 className="text-xl font-semibold text-red-800 mb-4">기후변화의 현실</h3>
              ...
              <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-400">
                <h3 className="text-xl font-semibold text-blue-800 mb-4">우리의 역할</h3>
              ...
              <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-400">
                <h3 className="text-xl font-semibold text-green-800 mb-4">시민단체로서의 우리</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-400">
                <h3 className="text-xl font-semibold text-purple-800 mb-4">미래 비전</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* 서명 */}
              <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-8 rounded-xl text-center border-2 border-green-200">
                <p className="text-lg text-gray-700 mb-4">(사)전북생명의숲 공동대표</p>
                <div className="flex flex-wrap justify-center gap-4 text-lg font-semibold text-green-800">
                  <span>박해영</span>
                  <span>박종민</span>
                  <span>김정숙</span>
                </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-lg border-l-4 border-green-500">
                <div className="prose prose-lg max-w-none text-gray-800 leading-relaxed">
                  ...
                  <div className="mt-8 pt-6 border-t-2 border-green-200 text-center">
                    <p className="text-lg font-semibold text-green-800">2003. 8. 7</p>
                    <p className="text-xl font-bold text-green-900">전북 생명의 숲 창립준비위원회 일동</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          content: (
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-xl border border-green-200">
                <h3 className="text-2xl font-bold text-green-800 mb-8 text-center">조직도</h3>
                
                <div className="flex flex-col items-center space-y-6">
                  {/* 최고 지도층 */}
                  <div className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold text-center min-w-[200px]">
                    공동대표 / 이사장
                  </div>
                  
                  {/* 이사회와 감사 */}
                  <div className="flex justify-center space-x-8">
                    <div className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold text-center min-w-[120px]">
                      이사회
                    </div>
                    <div className="bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold text-center min-w-[80px]">
                      감사
                    </div>
                  </div>
                  
                  {/* 운영위원회 */}
                  <div className="bg-orange-500 text-white px-6 py-3 rounded-lg font-semibold text-center min-w-[150px]">
                    운영위원회
                  </div>
                  
                  {/* 4개 분과 */}
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-purple-400 text-white px-4 py-2 rounded-lg font-medium text-center text-sm">
                      탄소중립숲분과
                    </div>
                    <div className="bg-purple-400 text-white px-4 py-2 rounded-lg font-medium text-center text-sm">
                      숲문화탐방분과
                  ...
                  {/* 사무국 */}
                  <div className="bg-yellow-500 text-white px-6 py-3 rounded-lg font-semibold text-center min-w-[100px]">
                    사무국
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-green-500">
                  <h3 className="text-xl font-bold text-green-800 mb-4">공동대표</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-gray-500">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">감사</h3>
                  <div className="space-y-2 text-gray-700">
                    <p>• 사업감사: 양차랑 (국립생태원)</p>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
                  <h3 className="text-xl font-bold text-blue-800 mb-4">이사회</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-orange-500">
                  <h3 className="text-xl font-bold text-orange-800 mb-4">운영위원회 (운영위원장: 황중하)</h3>
                  
                  {/* 탄소중립분과 */}
                  <div className="mb-6 p-4 bg-purple-50 rounded-lg">
                    <h4 className="text-lg font-semibold text-purple-800 mb-2">탄소중립분과</h4>
                    <p className="text-purple-700 mb-2">분과장: 박해영</p>
                    <p className="text-purple-700">분과위원: 김연주, 김창석</p>
                  </div>

                  {/* 숲문화탐방분과 */}
                  <div className="mb-6 p-4 bg-purple-50 rounded-lg">
                    <h4 className="text-lg font-semibold text-purple-800 mb-2">숲문화탐방분과</h4>
                    <p className="text-purple-700 mb-2">분과장: 전정일</p>
                    <p className="text-purple-700">분과위원: 박영호, 박형근, 차옥순</p>
                  </div>

                  {/* 숲교육분과 */}
                  <div className="mb-6 p-4 bg-purple-50 rounded-lg">
                    <h4 className="text-lg font-semibold text-purple-800 mb-2">숲교육분과</h4>
                    <p className="text-purple-700 mb-2">분과장: 정진권</p>
                    <p className="text-purple-700">분과위원: 김기수, 김은아, 오광민, 이근자, 박은미</p>
                  </div>

                  {/* 숲조직홍보분과 */}
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="text-lg font-semibold text-purple-800 mb-2">숲조직홍보분과</h4>
                    <p className="text-purple-700 mb-2">분과장: 황중하</p>
                    <p className="text-purple-700">분과위원: 김계숙, 김기수, 김석균, 박정섭</p>
                  </div>
                </div>
              </div>
            </div>
